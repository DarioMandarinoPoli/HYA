    ...
    >
      ...
      <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
        ...
        <div class="image-div col-lg-4 offset-lg-1 p-0 overflow-hidden shadow-lg" >
          <!-- <img class="rounded-lg-3" :src="img" alt="" width=""  @click="click" /> -->
          <img class="rounded-lg-3" id="myImg" :src="img" :alt="name" width=""  />
          <!-- The Modal -->
        ...
        <!--b-class made by Dario-->
        <b class="b-class">Description:</b>
        <p class="lead">
          {{ breed }}
        </p>
        <!-- <b class="b-class">Practical Information:</b>
        <p class="lead">
          {{ practInfo }}
        </p> -->
        
        <!-- <b class="b-class">More Information:</b><br>
...
export default {
  ...
  mounted(){    this.fullsize()
  },
  methods: {
    backToList() {
      this.$router.push('/places')
    },
    // var my_element = document.getElementById("app");
